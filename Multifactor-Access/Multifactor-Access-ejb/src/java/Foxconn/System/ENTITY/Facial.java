 ...
 */
@Entity
@Table(name = "tb_facial")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Facial.findAll", query = "SELECT f FROM Facial f")
    , @NamedQuery(name = "Facial.findById", query = "SELECT f FROM Facial f WHERE f.id = :id")})
public class Facial implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Facial)) {
            return false;
        }
        Facial other = (Facial) object;
    ...
    public String toString() {
        return "Foxconn.System.ENTITY.Facial[ id=" + id + " ]";
    }
